...
function countdown() {
    ...
    var launch_date = new Date(Date.UTC(2018, 3, 1, 0, 0));
    var days;
    var hours;
    var minutes;
    var seconds;
    ...
    ctd.innerHTML =
        '<li>' + days + '<span> day' + (days > 1 ? 's' : '') + '</span></li>' +
        '<li>' + hours + '<span> hour' + (hours > 1 ? 's' : '') + '</span></li>' +
        '<li>' + minutes + '<span> minute' + (minutes > 1 ? 's' : '') + '</span></li>' +
        '<li>' + seconds + '<span> second' + (seconds > 1 ? 's' : '') + '</span></li>';
